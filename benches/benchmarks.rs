...
use tvm_block::{
    Account, ConfigParams, Deserializable, Serializable, Transaction, TransactionDescr,
};
use tvm_executor::{
    BlockchainConfig, ExecuteParams, OrdinaryTransactionExecutor, TickTockTransactionExecutor,
    TransactionExecutor,
};
use tvm_types::{error, fail, Cell, Result, Status, UInt256};
...
fn bench_real_transaction(c: &mut Criterion) {
    replay_transaction_by_files(
        ...
        "real_tvm_boc/simple_account_old.boc",
        "real_tvm_boc/simple_account_new.boc",
        "real_tvm_boc/simple_transaction.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn bench_real_deploy_transaction(c: &mut Criterion) {
    replay_transaction_by_files(
        ...
        "real_tvm_boc/deploy_account_old.boc",
        "real_tvm_boc/deploy_account_new.boc",
        "real_tvm_boc/deploy_transaction.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn bench_init_account_transaction(c: &mut Criterion) {
    replay_transaction_by_files(
        ...
        "real_tvm_boc/init_account_old.boc",
        "real_tvm_boc/init_account_new.boc",
        "real_tvm_boc/init_transaction.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn bench_check_execute_bounced_message(c: &mut Criterion) {
    replay_transaction_by_files(
        ...
        "real_tvm_boc/bounce_msg_account_old.boc",
        "real_tvm_boc/bounce_msg_account_new.boc",
        "real_tvm_boc/bounce_msg_transaction.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn bench_check_execute_out_message_with_body_in_ref(c: &mut Criterion) {
    replay_transaction_by_files(
        ...
        "real_tvm_boc/msg_body_ref_account_old.boc",
        "real_tvm_boc/msg_body_ref_account_new.boc",
        "real_tvm_boc/msg_body_ref_transaction.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn bench_check_execute_uninit_account(c: &mut Criterion) {
    replay_transaction_by_files(
        ...
        "real_tvm_boc/uninit_account_old.boc",
        "real_tvm_boc/uninit_account_new.boc",
        "real_tvm_boc/uninit_account_transaction.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn bench_check_send_remainig_msg_balance(c: &mut Criterion) {
    replay_transaction_by_files(
        ...
        "real_tvm_boc/send_remainig_msg_balance_account_old.boc",
        "real_tvm_boc/send_remainig_msg_balance_account_new.boc",
        "real_tvm_boc/send_remainig_msg_balance_transaction.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn bench_check_out_of_gas_transaction(c: &mut Criterion) {
    replay_transaction_by_files(
        ...
        "real_tvm_boc/out_of_gas_account_old.boc",
        "real_tvm_boc/out_of_gas_account_new.boc",
        "real_tvm_boc/out_of_gas_transaction.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn bench_check_wrong_skip_reason(c: &mut Criterion) {
    replay_transaction_by_files(
        ...
        "real_tvm_boc/wrong_skip_reason_account_old.boc",
        "real_tvm_boc/wrong_skip_reason_account_new.boc",
        "real_tvm_boc/wrong_skip_reason_transaction.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn bench_check_wrong_compute_phase(c: &mut Criterion) {
    replay_transaction_by_files(
        ...
        "real_tvm_boc/wrong_compute_phase_account_old.boc",
        "real_tvm_boc/wrong_compute_phase_account_new.boc",
        "real_tvm_boc/wrong_compute_phase_transaction.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn bench_check_nofunds_to_send_message_without_error(c: &mut Criterion) {
    replay_transaction_by_files(
        ...
        "real_tvm_boc/nofunds_without_error_account_old.boc",
        "real_tvm_boc/nofunds_without_error_account_new.boc",
        "real_tvm_boc/nofunds_without_error_transaction.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn bench_bounce_message_to_new_account(c: &mut Criterion) {
    replay_transaction_by_files(
        ...
        "real_tvm_boc/bounce_message_to_new_account_account_old.boc",
        "real_tvm_boc/bounce_message_to_new_account_account_new.boc",
        "real_tvm_boc/bounce_message_to_new_account_transaction.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn bench_freeze_account(c: &mut Criterion) {
    replay_transaction_by_files(
        ...
        "real_tvm_boc/freeze_account_old.boc",
        "real_tvm_boc/freeze_account_new.boc",
        "real_tvm_boc/freeze_transaction.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn bench_send_to_frozen_account(c: &mut Criterion) {
    replay_transaction_by_files(
        ...
        "real_tvm_boc/send_to_frozen_account_old.boc",
        "real_tvm_boc/send_to_frozen_account_new.boc",
        "real_tvm_boc/send_to_frozen_transaction.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn bench_unfreeze_account(c: &mut Criterion) {
    replay_transaction_by_files(
        ...
        "real_tvm_boc/unfreeze_account_old.boc",
        "real_tvm_boc/unfreeze_account_new.boc",
        "real_tvm_boc/unfreeze_transaction.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn bench_bounce_to_empty_account(c: &mut Criterion) {
    replay_transaction_by_files(
        ...
        "real_tvm_boc/bounce_to_empty_account_old.boc",
        "real_tvm_boc/bounce_to_empty_account_new.boc",
        "real_tvm_boc/bounce_to_empty_transaction.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn bench_bounce_to_low_balance_account(c: &mut Criterion) {
    replay_transaction_by_files(
        ...
        "real_tvm_boc/bounce_to_low_balance_account_old.boc",
        "real_tvm_boc/bounce_to_low_balance_account_new.boc",
        "real_tvm_boc/bounce_to_low_balance_transaction.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn bench_depool_balance_check(c: &mut Criterion) {
    replay_transaction_by_files(
        ...
        "real_tvm_boc/depool_balance_check_account_old.boc",
        "real_tvm_boc/depool_balance_check_account_new.boc",
        "real_tvm_boc/depool_balance_check_transaction.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn bench_no_balance_to_send_transaction(c: &mut Criterion) {
    replay_transaction_by_files(
        ...
        "real_tvm_boc/no_balance_to_send_account_old.boc",
        "real_tvm_boc/no_balance_to_send_account_new.boc",
        "real_tvm_boc/no_balance_to_send_transaction.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn bench_int_message_to_elector_transaction(c: &mut Criterion) {
    replay_transaction_by_files(
        ...
        "real_tvm_boc/int_message_to_elector_account_old.boc",
        "real_tvm_boc/int_message_to_elector_account_new.boc",
        "real_tvm_boc/int_message_to_elector_transaction.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn bench_int_message_to_elector2_transaction(c: &mut Criterion) {
    replay_transaction_by_files(
        ...
        "real_tvm_boc/int_message_to_elector2_account_old.boc",
        "real_tvm_boc/int_message_to_elector2_account_new.boc",
        "real_tvm_boc/int_message_to_elector2_transaction.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn bench_ihr_message(c: &mut Criterion) {
    replay_transaction_by_files(
        Some((c, "ihr_message")),
        "real_tvm_boc/ihr_message_account_old.boc",
        "real_tvm_boc/ihr_message_account_new.boc",
        "real_tvm_boc/ihr_message_transaction.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn bench_tick_tock_message(c: &mut Criterion) {
    replay_transaction_by_files(
        ...
        "real_tvm_boc/tick_tock_acc_old.boc",
        "real_tvm_boc/tick_tock_acc_new.boc",
        "real_tvm_boc/tick_tock_tx.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn bench_count_steps_vm(c: &mut Criterion) {
    replay_transaction_by_files(
        ...
        "real_tvm_boc/count_steps_acc_old.boc",
        "real_tvm_boc/count_steps_acc_new.boc",
        "real_tvm_boc/count_steps_tx.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn bench_not_aborted_accepted_transaction(c: &mut Criterion) {
    replay_transaction_by_files(
        ...
        "real_tvm_boc/not_abort_accept_account_account_old.boc",
        "real_tvm_boc/not_abort_accept_account_account_new.boc",
        "real_tvm_boc/not_abort_accept_account_transaction.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn bench_ihr_fee_output_msg(c: &mut Criterion) {
    replay_transaction_by_files(
        Some((c, "ihr_fee_output_msg")),
        "real_tvm_boc/ihr_fee_account_old.boc",
        "real_tvm_boc/ihr_fee_account_new.boc",
        "real_tvm_boc/ihr_fee_transaction.boc",
        "real_tvm_boc/config.boc",
    )
}
...
fn load_block(block_filename: &str) -> Result<BlockData> {
    ...
    for acc in block.accounts {
        ...
        accounts.push(BlockAccountData {
            account_cell,
            transactions,
        });
    }
    ...
    for acc in data.accounts {
        ...
        for tr in acc.transactions {
            let executor: Box<dyn TransactionExecutor> = match tr.read_description()? {
                TransactionDescr::TickTock(desc) => Box::new(TickTockTransactionExecutor::new(
                    data.config.clone(),
                    desc.tt,
                )),
...
fn bench_block_0(c: &mut Criterion) {
    ...
    c.bench_function("block-0", |b| {
        b.iter(|| replay_block(block.clone()).expect("replay failed"))
    });
}
